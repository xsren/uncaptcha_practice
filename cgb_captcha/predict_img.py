...
class Predict(object):
    ...
    def create_model(self):
        ...
        model.add(Conv2D(32, (3, 3), activation='relu', input_shape=(36, 90, 1)))
...
if __name__ == '__main__':
    bar = Predict()
    bar.predict_img('1.jpg')
    bar.predict_img('2.jpg')
    bar.predict_img('3.jpg')
    bar.predict_img('4.jpg')
